...
const KEYFRAMES = [
  ...
  { pos: [-28, 16, 52], look: [0, 9, 0] }, // 03 Lifecycle — descend over the terrain
  { pos: [30, 12, 40], look: [0, 6, 0] }, // 04 Casa Nuba
  { pos: [-34, 16, 36], look: [0, 6, 0] }, // 05 Bodeflex
  { pos: [26, 12, 46], look: [0, 6, 0] }, // 06 +Value
  { pos: [0, 80, 120], look: [0, 6, 0] }, // 07 Leadership — pulled back
    ...
    <div className="scene-canvas">
      ...
      >
        ...
        <EffectComposer disableNormalPass>
          <Bloom intensity={0.6} luminanceThreshold={0.6} luminanceSmoothing={0.25} mipmapBlur />
